...
class Terrain:
    def __init__(self, app, position=(0, 0, 0), width=40, depth=40, max_height=75.0,
...
class Grass:
    def __init__(self, app, position=(0, 0, 0), texture: str = 'grass_0',
                 terrain: Terrain = None,
                 albedo=(1.0, 1.0, 1.0), roughness=0.6, metallic=0.1):
        self.app = app
        self.ctx = app.ctx
        self.terrain = terrain
        self.pos = glm.vec3(position)
...
class Scene():
    ...
    def __init__(self, app):
        ...
        self.terrain = Terrain(self.app)
        self.objects.append(Grass(self.app, terrain=self.terrain))
        self.objects.append(Ground(self.app, terrain=self.terrain))
