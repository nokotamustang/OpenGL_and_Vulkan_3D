...
void LveRenderer::recreateSwapChain() {
    ...
    if (lveSwapChain == nullptr) {
        lveSwapChain = make_unique<LveSwapChain>(lveDevice, extent);
    } else {
        shared_ptr<LveSwapChain> oldSwapChain = move(lveSwapChain);
        lveSwapChain = make_unique<LveSwapChain>(lveDevice, extent, oldSwapChain);
