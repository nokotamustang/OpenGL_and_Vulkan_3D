...
unique_ptr<LveDescriptorSetLayout> LveDescriptorSetLayout::Builder::build() const {
    return make_unique<LveDescriptorSetLayout>(lveDevice, bindings);
}

LveDescriptorSetLayout::LveDescriptorSetLayout(
    LveDevice &lveDevice, unordered_map<uint32_t, VkDescriptorSetLayoutBinding> bindings)
...
unique_ptr<LveDescriptorPool> LveDescriptorPool::Builder::build() const {
    return make_unique<LveDescriptorPool>(lveDevice, maxSets, poolFlags, poolSizes);
}
...
void LveDescriptorPool::freeDescriptors(vector<VkDescriptorSet> &descriptors) const {
