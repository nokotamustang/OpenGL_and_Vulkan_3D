...
#include <glad/gl.h>
//
#define STB_IMAGE_IMPLEMENTATION  // Define this once per project
#include "stb_image.h"
//
#include "app.hpp"
...
void App::run() {
    ...
    root_path = "";
#endif
    string vert_shader = root_path + "shaders/default.vert";
    string frag_shader = root_path + "shaders/default.frag";
